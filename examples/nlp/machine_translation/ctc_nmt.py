...
from nemo.collections.nlp.models import MTCTCModel
...
class MTEncDecConfig(NemoConfig):
    ...
    exp_manager: Optional[ExpManagerConfig] = ExpManagerConfig(name='MTCTC', files_to_copy=[])
...
def main(cfg: MTEncDecConfig) -> None:
    ...
    mt_model = MTCTCModel(cfg.model, trainer=trainer)
